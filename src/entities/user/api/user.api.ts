...
export class AuthApi {
  ...
  static async login(credentials: TLoginCredentials): Promise<ApiResponse<TAuthResponse>> {
  ...
  static async register(credentials: TRegisterCredentials): Promise<ApiResponse<TAuthResponse>> {
  ...
  static async refreshToken(refreshToken: string): Promise<ApiResponse<TAuthTokens>> {
  ...
  static async getProfile(signal?: AbortSignal): Promise<ApiResponse<TUser>> {
